...
while number
  puts englishNumber(number) + ' bottles of beer on the wall, ' + englishNumber(number) + ' bottles of beer. Take one down and pass it around, ' + englishNumber(number - 1) + ' bottles of beer on the wall.'
  puts ''
  number -= 1
  if number == 0
    puts 'No more bottles of beer on the wall, no more bottles of beer.
Go to the store and buy some more, 9999 bottles of beer on the wall.'
    number = 9999
  end
